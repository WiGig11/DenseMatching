...
from training.losses.neg_log_likelihood import NLLMixtureLaplace,NLLMixtureLaplaceandGaussian
...
from models.VMPNet.VMPNet import VMPNet_vgg16
...
def run(settings):
    ...
    model = VMPNet_vgg16(global_gocor_arguments=global_gocor_arguments, global_corr_type='GlobalGOCor',
    ...
    objective = NLLMixtureLaplaceandGaussian()
